...
func UnpackTarFromGCSBucket(bucketName string) (string, error) {
	...
	buildContextPath := filepath.Join(constants.BuildContextDir)
	err = pkgutil.UnTar(file, buildContextPath, nil)
	return buildContextPath, err
}
